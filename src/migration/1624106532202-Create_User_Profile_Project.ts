...
export class CreateUserProfileProject1624106532202 implements MigrationInterface {
    name = 'CreateUserProfileProject1624106532202'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "project_area" ("created_dt" TIMESTAMP NOT NULL DEFAULT now(), "updated_dt" TIMESTAMP NOT NULL DEFAULT now(), "deleted_dt" TIMESTAMP, "id" SERIAL NOT NULL, "area" character varying(50) NOT NULL, CONSTRAINT "PK_c8c8b08f31da596f597a4492e6c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "project_photo" ("created_dt" TIMESTAMP NOT NULL DEFAULT now(), "updated_dt" TIMESTAMP NOT NULL DEFAULT now(), "deleted_dt" TIMESTAMP, "id" SERIAL NOT NULL, "photo" character varying, "project_id" integer, CONSTRAINT "PK_c24a04e26269103eb19427429cd" PRIMARY KEY ("id"))`);
