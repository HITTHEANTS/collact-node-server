...
export class InitDatabase1618488799819 implements MigrationInterface {
  name = 'InitDatabase1618488799819';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "profile" ("created_dt" TIMESTAMP NOT NULL DEFAULT now(), "updated_dt" TIMESTAMP NOT NULL DEFAULT now(), "deleted_dt" TIMESTAMP, "user_id" integer NOT NULL, "photo" character varying, "contact" character varying(50), "intro" character varying(50), "details" text, "email" character varying, "phone" character varying(15), CONSTRAINT "REL_d752442f45f258a8bdefeebb2f" UNIQUE ("user_id"), CONSTRAINT "PK_d752442f45f258a8bdefeebb2f2" PRIMARY KEY ("user_id"))`,
    );
    await queryRunner.query(
